...
func TestGetTime(t *testing.T) {
	...
	myAssertion(t, time1, "day")
	myAssertion(t, time1, "hour")
	myAssertion(t, time1, "min")
	myAssertion(t, time2, "day")
	myAssertion(t, time2, "hour")
	myAssertion(t, time2, "min")
}
func myAssertion(t *testing.T, logTime, timeType string) {
	num, _ := strconv.Atoi(getTime(logTime, timeType))
	assert.True(t, num > 0)
}
